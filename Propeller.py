...
class Propeller(Energy_Component):
    ...
    def spin(self,conditions):
        ...
        if self.freestream_case == 'disturbed_freestream':
            ua_wing             = self.wing_ua
            ut_wing             = self.wing_ut
    ...
    def spin_simple_pusher(self,conditions):
        ...
        if case == 'disturbed_freestream':
            ...
            ua_wing             = np.zeros_like(self.wing_ua)
            ut_wing             = np.zeros_like(self.wing_ut)
